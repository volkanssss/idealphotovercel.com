"use strict";(()=>{var e={};e.id=6717,e.ids=[6717],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},97347:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>w,patchFetch:()=>x,requestAsyncStorage:()=>g,routeModule:()=>b,serverHooks:()=>v,staticGenerationAsyncStorage:()=>y});var a={};o.r(a),o.d(a,{default:()=>c});var s={};o.r(s),o.d(s,{GET:()=>f});var i=o(49303),n=o(88716),r=o(60670),l=o(55661);let h=[{id:10,title:"Best Online Photo Booths in 2026: Easy4Cut, Memorify, Pica Pica & More",excerpt:"A comprehensive comparison of the best online photo booths including easy4cut, memorify, pica pica, and more. Find the perfect photo booth for your needs.",category:"Comparison",date:"February 18, 2026",imageUrl:"https://placehold.co/600x400/F59E0B/FFFFFF?text=Photo+Booth+Comparison",slug:"best-online-photo-booths-2026",author:{name:"David Park",avatar:"https://placehold.co/200/F59E0B/FFFFFF?text=DP",role:"Tech Editor"},tags:["online photo booth","easy4cut","memorify","pica pica","photo booth comparison","digibooth"],content:`
  ...
  `}];function c(){let e="https://idealphotovercel.com";return[...["","/about","/contact","/faq","/pricing","/privacy-policy","/terms-of-service","/cookie-policy","/sitemap-page","/blog","/kpop-photobooth","/vintage-photobooth","/digibooth","/wedding-photobooth","/pica-pica-booth","/easy4cut-photo-booth","/memorify-photo-booth","/selfie-booth","/party-booth","/chinchinbooth","/beautyplus-booth","/jepreto-booth"].map(t=>({url:`${e}${t}`,lastModified:new Date("2026-02-21"),changeFrequency:"weekly",priority:""===t?1:t.includes("photobooth")||t.includes("booth")||t.includes("digibooth")?.9:.7})),...h.map(t=>({url:`${e}/blog/${t.slug}`,lastModified:new Date("2026-02-21"),changeFrequency:"monthly",priority:.6}))]}var p=o(60707);let m={...a},d=m.default,u=m.generateSitemaps;if("function"!=typeof d)throw Error('Default export is missing in "C:\\Users\\vlkne\\OneDrive\\Desktop\\remix-of-celebframe-funhouse-main\\remix-of-celebframe-funhouse-main\\src\\app\\sitemap.ts"');async function f(e,t){let o;let{__metadata_id__:a,...s}=t.params||{},i=u?await u():null;if(i&&null==(o=i.find(e=>{let t=e.id.toString();return(t+=".xml")===a})?.id))return new l.NextResponse("Not Found",{status:404});let n=await d({id:o}),r=(0,p.resolveRouteData)(n,"sitemap");return new l.NextResponse(r,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}let b=new i.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap",bundlePath:"app/sitemap.xml/route"},resolvedPagePath:"next-metadata-route-loader?page=%2Fsitemap.xml%2Froute&filePath=C%3A%5CUsers%5Cvlkne%5COneDrive%5CDesktop%5Cremix-of-celebframe-funhouse-main%5Cremix-of-celebframe-funhouse-main%5Csrc%5Capp%5Csitemap.ts&isDynamic=1!?__next_metadata_route__",nextConfigOutput:"",userland:s}),{requestAsyncStorage:g,staticGenerationAsyncStorage:y,serverHooks:v}=b,w="/sitemap.xml/route";function x(){return(0,r.patchFetch)({serverHooks:v,staticGenerationAsyncStorage:y})}}};var t=require("../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),a=t.X(0,[8948,1346],()=>o(97347));module.exports=a})();