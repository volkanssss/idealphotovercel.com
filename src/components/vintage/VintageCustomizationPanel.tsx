...
interface VintageCustomizationPanelProps {
...
const VintageCustomizationPanel: React.FC<VintageCustomizationPanelProps> = ({
  frameColor,
  setFrameColor,
  sticker,
  setSticker,
  ...
  return (
    <div className="mx-auto bg-amber-50/90 backdrop-blur-md p-2 rounded-lg shadow-sm overflow-x-auto border border-amber-200">
...
export default VintageCustomizationPanel;
